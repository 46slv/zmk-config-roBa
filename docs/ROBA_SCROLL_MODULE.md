...
From the WSL `zmk-workspace` development shell:

```sh
nix develop -c bash -lc \
  'make -C /mnt/c/Users/shiro/.codex/worktrees/c5ab/zmk-config-roBa/tests clean test && \
   make -C /mnt/c/Users/shiro/.codex/worktrees/c5ab/zmk-config-roBa/tests clean'
```
